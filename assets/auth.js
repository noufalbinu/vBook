document.addEventListener('DOMContentLoaded', function(e) {
    const showAuthBtn = document.getElementById('zon-show-auth-form'),
        authContainer = document.getElementById('zon-auth-container'),
        close = document.getElementById('zon-auth-close'),
        authForm = document.getElementById('zon-auth-form'),
    ...
    authForm.addEventListener('submit', e => {
        ...
        let data = {
            ...
            nonce: authForm.querySelector('[name="zon_auth"]').value
        }
