...
* 
*/
class ZonPackageFixed extends BaseController {

	public function register()
	{
		if ( ! $this->activated( 'fixed_packages' ) ) return;
    ...
    global $post;
    	if ($post->post_type == "fixedpackages" && $template !== locate_template(array("fixedpackges.php"))){
    		return ("$this->plugin_path/templates/fixedpackges.php");
    	} 
	...
	public function custom_post_type() 
	{
		...
		register_post_type( 'fixedpackages', $args );
	}
