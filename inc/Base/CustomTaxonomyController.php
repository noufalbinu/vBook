...
class CustomTaxonomyController extends BaseController
{
	...
	public function setSettings()
	{
		$args = array(
			array(
				'option_group' => 'zon_packages_tax_settings',
				'option_name' => 'zon_packages_tax',
	...
	public function setFields()
	{
		$args = array(
			array(
				...
				'page' => 'zon_taxonomy',
				'section' => 'zon_tax_index',
				'args' => array(
					'option_name' => 'zon_plugin_tax',
					'label_for' => 'taxonomy',
	...
	{
		$options = get_option( 'zon_packages_tax' ) ?: array();
